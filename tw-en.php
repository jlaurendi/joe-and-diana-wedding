...
<head>
    ...
    <meta property="og:image" content="http://josephanddiana.com/images/hero.jpg">
...
<!--                             <li><a href="#wedding-gallery">Gallery</a></li>
 -->                            <li><a href="#gift-registry">Gifts</a></li>
                            ...
                            <li class="country">
                                <a href="http://www.achiaohemeiying.com/tw-en.php" class="selected-country">TW</a>
                                <p>/</p>
                                <a href="http://www.josephanddiana.com/us-en.php">US</a>
                            </li>
        ...
        <div class="container">
            <div class="hero-inner">
                ...
                <div class="info">
                   <div id="countdown" class="countdown countdown-tw"> 365 <span>days</span> 0 <span>hours</span> 0 <span>mins</span> 0 <span>secs</span></div>
                   <span id="date" class="date">
                        January 9th, 2016 - Kaohsiung, Taiwan
                    </span>
                </div>
...
//                            $query = "SELECT * FROM guestbook WHERE wedding='tw'";
        ...
        <section id="contact" class="bgcolor">
            <header class="section-header">
                ...
                <p class="section-tagline">Please RSVP before 15 November 2015.</p>
            </header>
            <div class="form">
                <div class="container smaller">
                    <div class="row">
