...
<!--                             <li><a href="#wedding-gallery">Gallery</a></li>
 -->                            <li><a href="#guestbook">留言給我們</a></li>
                            ...
                            <li class="country">
                                <a href="http://www.achiaohemeiying.com/tw-zh.php">台灣</a>
                                <p>/</p>
                                <a href="http://www.josephanddiana.com/us-zh.php" class="selected-country">美國</a>
                            </li>
                            <li><a href="http://www.josephanddiana.com/us-en.php">English</a></li>
                        </ul>
                    </nav>
        ...
        <div class="container">
            <div class="hero-inner">
                ...
                <div class="info">
                    <div id="countdown" class="countdown countdown-us"> 365 <span>天</span> 0 <span>時</span> 0 <span>分</span> 0 <span>秒</span></div>
                    <span class="date">
                        2016年4月16日 - 美國南卡羅來納州
                    </span>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="column six heart right">
                        <div class="box center corner">
                            ...
                            <h2>婚禮</h2>
                            <div class="details">
                                <span class="waddress">台灣高雄市</span>
                    ...
                    <div class="column six heart left">
                        <div class="box center corner">
                            ...
                            <div class="details">
                                ...
                                <span class="wdate">2016年4月16日星期六</span>
                    ...
                    <div class="column six right">
                        ...
                        <div class="tab-content-wrap">
                            <div id="person1" class="tab-content">
                                <h2>阮玟揚</h2>
                                <div class="story">
                                    <p>玟揚與玫盈相識於雄女童軍，是個聽見帶動唱就渾然忘記腰部舊疾，活力四射擺動身軀與燦笑的副活動長。主修日文的她，過去在日本進行交換學生計畫一年。大學畢業後，曾在鋼鐵產業當過幾年的業務代表，決定轉職的她，目前十分期待未來的新生活。</p>
                                </div>
                                <div class="social">
                                    <ul>
                            ...
                            <div id="person2" class="tab-content">
                                <h2>陳人慈</h2>
                                <div class="story">
                                    <p>人慈也是雄女童軍的一員，雖然名字的諧音為仁慈，過去可是社團內負責扮演黑臉的訓練副主席，掌握著成員們的魔鬼訓練與課程計畫。人慈和玫盈相識於高中，大學也一起進入了政治大學。 應用數學科系畢業的她，目前也在國際知名的半導體公司－日月光任職。</p>
                                </div>
                                <div class="social">
                                    <ul>
                            ...
                            <div id="person3" class="tab-content">
                                <h2>卓靜如</h2>
                                <div class="story">
                                    <p>靜如和玫盈曾經同為雄女童軍的夥伴。巧合的是，重回校園的她，現在也是雄女童軍的指導老師，除此之外，靜如目前也任教於國中與補習班。她平日的最大休閒就是規劃旅程與旅行。</p>
                                </div>
                                <div class="social">
                                    <ul>
