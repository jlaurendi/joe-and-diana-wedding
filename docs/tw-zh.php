...
<!--                             <li><a href="#wedding-gallery">Gallery</a></li>
 -->                            <li><a href="#guestbook">留言給我們</a></li>
                            ...
                            <li class="country">
                                <a href="http://www.achiaohemeiying.com/tw-zh.php" class="selected-country">台灣</a>
                                <p>/</p>
                                <a href="http://www.josephanddiana.com/us-zh.php">美國</a>
                            </li>
                            <li><a href="http://www.achiaohemeiying.com/tw-en.php">English</a></li>
                        </ul>
                    </nav>
        ...
        <div class="container">
            <div class="hero-inner">
                ...
                <div class="info">
                    <div id="countdown" class="countdown countdown-tw"> 365 <span>天</span> 0 <span>時</span> 0 <span>分</span> 0 <span>秒</span></div>
                    <span class="date">
                        2016年1月9日 - 台灣高雄市
                    </span>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="column six left">
                        ...
                        <div class="story">
                            ...
                            <p>對生命充滿熱情，無可救藥地熱衷於追求卓越的益智表現，喜歡接受挑戰，享受抽絲剝繭的腦力激盪，數學、電腦科學與創業是最愛。在智力挑戰以外，熱愛跑步與探索新世界，已經跑過10個馬拉松的他，目標是跑遍全世界的馬拉松。人生最大的夢想就是成為「對這個世界有貢獻」的人。</p>
                ...
                <div class="row">
                    ...
                    <div class="column six heart right">
                        <div class="box pattern">
                            ...
                            <div class="box-content">
                                <p>阿喬人生中第一次的台灣行，Joe和霄一與她的朋友孜力一起旅行。從台北一路往南的旅行中，這一天，他和兩位朋友Sherry、孜力來到高雄，阿喬和玫盈相遇了，故事由此開始。<p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="column six heart left">
                        <div class="box pattern">
                            ...
                            <div class="box-content">
                                <p>拜訪完高雄後，阿喬、霄一與孜力繼續他們未完的旅程，玫盈決定加入他們，一起去墾丁旅行。記得一個下午，我們肩並肩坐在白沙灣的沙灘上，讓海浪拍打著，天南地北地聊天，隨著彼此更加地認識，愛苗漸漸滋長。</p>
                            </div>
                    ...
                    <div class="column six heart right">
                        <div class="box pattern">
                            ...
                            <div class="box-content">
                                <p>阿喬結束了短暫的台灣行，回到了美國，暑假過後，參加交換學生計畫的玫盈搬去了上海。他們仍然持續不斷的透過網路聯絡著，也漸漸認識了彼此。經過幾個月的聯繫，阿喬瞭解了這個女孩是多麼的特別，不想再錯過她。因為想當面問玫盈是否願意成為他的女朋友，阿喬決定賭下所有義無反顧地來到上海，很幸運地，被阿喬打動的玫盈說她願意成為阿喬的女朋友。他們一起度過難忘的跨年夜，也一起進行了一個多月的旅行。</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="column six heart right">
                        <div class="box pattern">
                            ...
                            <div class="box-content">
                                <p>愛上東南亞的阿喬和玫盈，規劃了一個工作旅行，這次去了Malaysia（馬來西亞）、Singapore（新加坡）、Cambodia（柬埔寨）及Vietnam（越南），不僅見識了東南亞雨季中豐沛可觀的雨量，更喜歡他們不同種族間和平共處的氛圍，當然最愛是他們的食物。</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="column six heart left">
                        <div class="box pattern">
                            ...
                            <div class="box-content">
                                <p>阿喬即將參加新創公司加速器的三個月培育計劃，知道在那之前彼此將會有一段時間無法見面，剛離開亞洲一個多月的阿喬，決定在計畫開始前，火速訂了機票，第四次來到台灣，這時候的玫盈渾然不知他暗中的計畫。</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="column six heart right">
                        <div class="box pattern">
                            ...
                            <h2>The Proposal</h2>
                            <div class="box-content">
                                <p>來到台灣大約一個禮拜後，阿喬和玫盈再次回到520天前我們相識相戀的同個地方－墾丁，下午5點20分，阿喬單腳下跪向玫盈求婚了，又驚又喜的玫盈：「Yes, I do.」。</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="column six heart right">
                        <div class="box center corner">
                            ...
                            <div class="details">
                                ...
                                <span class="wdate">2016年1月9日星期六</span>
 ...
 -->                        </div>
                    ...
                    <div class="column six heart left">
                        <div class="box center corner">
                            ...
                            <h2>婚禮</h2>
                            <div class="details">
                                <span class="waddress">Charleson, USA</span>
                    ...
                    <div class="column six right">
                        ...
                        <div class="tab-content-wrap">
                            <div id="person1" class="tab-content">
                                ...
                                <div class="social">
                                    <ul>
                                        <li><a href="https://www.facebook.com/xihan.liang" target="_blank"><i class="fa fa-facebook"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div id="person2" class="tab-content">
                                ...
                                <div class="social">
                                    <ul>
                                        <li><a href="https://www.facebook.com/eva.tseng.90" target="_blank"><i class="fa fa-facebook"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div id="person3" class="tab-content">
                                <h2>蔡鈺羚</h2>
                                <div class="story">
                                    <p>不僅是雄女童軍的好夥伴，也是玫盈在政大財政系的好朋友。才華洋溢的鈺羚，不僅會跳舞，更是靠著自學通過日文N1檢定考。大學畢業後進入會計事務所工作，目前剛轉職，往人生的下一個里程碑邁進。</p>
                                </div>
                                <div class="social">
                                    <ul>
                                        <li><a href="https://www.facebook.com/ullia.tsai" target="_blank"><i class="fa fa-facebook"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div id="person4" class="tab-content">
                                ...
                                <div class="social">
                                    <ul>
                                        ...
                                        <li><a href="http://www.linkedin.com/profile/view?id=38969067" target="_blank"><i class="fa fa-linkedin"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
<!--                             <div class="column six">
                            ...
                            <input type="hidden" name="which-wedding" value="Taiwan" />
